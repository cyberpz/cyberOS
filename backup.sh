...
mkdir -p home/user/.local/bin
for script in launch-polybar.sh polybar-hover-monitor.sh polybar-wireguard.sh polybar-bluetooth.sh polybar-kdeconnect.sh bluetooth-menu.sh sync-to-nvme.sh standby.sh power-menu.sh redshift-start.sh brightness-max.sh power-profile-toggle.sh firefox-optimize.sh kdeconnect-menu.sh domus-chat.sh setup-domus-chat-profile.sh clipmenu-rofi.sh; do
